...
```bash
docker save log-output:latest -o log-output.tar
docker cp log-output.tar desktop-control-plane:/log-output.tar
docker exec desktop-control-plane ctr -n k8s.io images import /log-output.tar
